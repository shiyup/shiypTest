...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    S.prototype.config = {limit: 10, loading: !0, cellMinWidth: 60}, S.prototype.render = function () {
        ...
        e.data && e.data.constructor === Array && delete i.config.data, i.config = t.extend({}, i.config, e), i.render()
        ...
        var a = c.config[e];
        return a ? (i.data && i.data.constructor === Array && delete a.data, d.render(t.extend(!0, {}, a, i))) : o.error("The ID option was not found in the table instance")
    }, d.render = function (e) {
        var t = new S(e);
        return c.call(t)
